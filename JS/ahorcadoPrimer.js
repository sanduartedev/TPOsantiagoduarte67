...
function cantidad_letras(){
    ...
    document.getElementById("span0").innerHTML = palabra[0] + "&nbsp"
...
function ganar(){
    if (parseInt(aciertos)==palabra.length){
        ...
        document.getElementById("imprimirPalabra").innerHTML = ""
        document.getElementById("cantidad_errores").innerHTML = "<img src='../img/ah.jpg' alt='ahorcado'>"
        errores=0
        aciertos=1
...
function perder(){
    if (parseInt(errores)>10){
        swal("¡Perdiste!", "Prueba otra vez")
        document.getElementById("imprimirPalabra").innerHTML = ""
        document.getElementById("letrasNo").innerHTML = ""
        document.getElementById("cantidad_errores").innerHTML = "<img src='../img/ah.jpg' alt='ahorcado 10'>"
        errores=0
        aciertos=1
        for (var i = 0; i < letras.length; i++)
            document.getElementById(letras[i]).type = "visibility"
...
function probar_letra(value){
    ...
    if (palabra.includes(value)){
        ...
        document.getElementById("cantidad_errores").innerHTML = "<img src='../img/ah" + errores + ".jpg' alt='ah'" + errores +">"
